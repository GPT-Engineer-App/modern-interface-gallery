...
const Index = () => {
  ...
  const handleAddUrl = () => {
    ...
    const newUrl = {
      id: Date.now(),
      link: url,
      image: `https://images.unsplash.com/photo-1617854818583-09e7f077a156?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHwlMjQlN0J1cmwlN0R8ZW58MHx8fHwxNzE1NTQ0NTc4fDA&ixlib=rb-4.0.3&q=80&w=1080`, // This will be replaced with an actual image URL
    ...
    <Container maxW="container.xl" py={8}>
      <VStack spacing={4}>
        ...
        <SimpleGrid columns={3} spacing={10} mt={10}>
          {urls.map(({ id, link, image, description }) => (
